...
import com.campusrecruitmentsystem.databinding.ActivitySuperAdminDashboardBinding;
...
public class SuperAdminDashboardActivity extends AppCompatActivity {
    ...
    private ActivitySuperAdminDashboardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceManager.getDefaultSharedPreferences(this).edit().putInt(getString(R.string.account_type), 3).apply();
        PreferenceManager.getDefaultSharedPreferences(this).edit().putBoolean("isBlocked", false).apply();

        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_manage_student, R.id.nav_manage_company,
                R.id.nav_manage_admin,
                R.id.nav_update_details, R.id.nav_change_password, R.id.nav_about_us)
            ...
            alertDialog.setMessage("Do you want to log out?").setTitle("LOG OUT")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            startActivity(new Intent(SuperAdminDashboardActivity.this, MainActivity.class));
                            finishAffinity();
                        }
                    })
...
//        NavController navController = Navigation.findNavController(this, R.id.company_fragment_container_view_tag);
    ...
    protected void onStart() {
        ...
        rootRef = FirebaseDatabase.getInstance().getReference().child("SuperAdmin").child(mAuth.getCurrentUser().getUid());
